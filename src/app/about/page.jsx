...
const AboutPage = () => {
  ...
  return (
    <div className="w-screen hide-scrollbar h-screen bg-[linear-gradient(311deg,#22b5fe,#ffbad6)]">
      <AuroraBackground>
        <div className=" absolute hide-scrollbar  flex w-screen h-[100vh]  overflow-y-scroll m-auto px-[5vw] sm:px-[10vw]  lg:px-[20vw] top-0 left-0 pb-0 mb-0">
          <motion.div
            className="m-auto mb-0 items-center justify-center  "
            initial={{ y: "-200vh" }}
            animate={{ y: "0%" }}
            ...
            <div className="  pt-5">
              <div className="flex flex-col  justify-center">
                ...
                <p className="text-lg pt-4">
                  ...
                  front-end design principles and backend integration, allowing
                  me to deliver high-quality, scalable solutions. With a keen
                  eye for design and a passion for learning, I’m a curious and
                  fast learner, consistently seeking to enhance my skills and
                ...
                >
                  ...
                  <div className="flex justify-between h-48">
                    ...
                    <div className="w-1/3 ">
                      ...
                      {/* JOB DESC */}
                      <div className="p-3 text-sm italic">
                        Learnt all the necessary tech stacks for Web
                        development. .{" "}
                      </div>
                      {/* JOB DATE */}
                      <div className="p-3 text-slate-900 text-sm font-semibold">
